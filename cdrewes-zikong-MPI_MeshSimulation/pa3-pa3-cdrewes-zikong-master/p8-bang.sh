...
mpirun -np 1 ~/pa3*/apf -n 400 -i 2000 -x 1 -y 1
mpirun -np 2 ~/pa3*/apf -n 400 -i 2000 -x 1 -y 2
#mpirun -np 3 ~/pa3*/apf -n 400 -i 2000 -x 1 -y 3
mpirun -np 4 ~/pa3*/apf -n 400 -i 2000 -x 1 -y 4
#mpirun -np 8 ~/pa3*/apf -n 400 -i 2000 -x 1 -y 8
#mpirun -np 2 ~/pa3*/apf -n 400 -i 2000 -x 1 -y 2
#mpirun -np 5 ~/pa3*/apf -n 400 -i 2000 -x 1 -y 5 
#mpirun -np 6 ~/pa3*/apf -n 400 -i 2000 -x 1 -y 6 
#mpirun -np 7 ~/pa3*/apf -n 400 -i 2000 -x 1 -y 7
mpirun -np 8 ~/pa3*/apf -n 400 -i 2000 -x 1 -y 8 
